...
// //       if (!title)
// //         return sendError(res, 400, "Title fields is missing"); 
// //       if (!description)
// //         return sendError(res, 400, "description fields missing");
// //       if (!plotSize )
// //         return sendError(res, 400, "plotSize fields missing");
// //       if (!price)
// //         return sendError(res, 400, "Price fields missing");
// //       if (!category)
// //         return sendError(res, 400, "Required fields missing");
...
//       if (!plotSize) return sendError(res, 400, "Plot size is required");
//       if (!plotSize.value) return sendError(res, 400, "Plot size value is required");
//       if (!plotSize.unit) return sendError(res, 400, "Plot size unit is required");
...
//       // If plotSize is being updated, ensure proper format
